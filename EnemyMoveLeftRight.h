...
public:
    EnemyMoveLeftRight(DirectionOfTravel direction, int xEnemy, int yEnemy, QGraphicsItem* parent = nullptr) :
        Enemy(direction, xEnemy, yEnemy, parent)
    {
